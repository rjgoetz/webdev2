...
document.getElementById("btn0").onclick = function () {
  if (button === false) {
    addArticleText("main", radishText);
    button = true;
  } else {
    addArticleText("main", initialText);
    button = false;
  }; 
};
